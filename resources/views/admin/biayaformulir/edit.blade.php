...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <!-- form start -->
            <form method="post"
                action="{{ route('admin.biayaformulir.update', $biayaformulir->id_list_pembayaran) }}"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_list_pembayaran" class="form-control @error('nama_list_pembayaran') is-invalid @enderror"
                            id="nama_list_pembayaran" value="{{ $biayaformulir->nama_list_pembayaran }}" placeholder="Nama Biaya">
                    ...
                    <div class="form-group">
                        <div class="col-sm-13 mb-2">
                            ...
                            <textarea class="form-control @error('rincian_list_pembayaran') is-invalid @enderror"
                                ...
                                placeholder="Rincian Biaya">{{ $biayaformulir->rincian_list_pembayaran }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="biaya" class="form-control @error('biaya') is-invalid @enderror"
                                id="biaya" value="{{ $biayaformulir->biaya }}" placeholder="Total Biaya">
                            @error('biaya')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
