...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="brand-link text-center">
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                <a href="{{ route('siswa.predaftar') }}" style="color:#fff;"><p style="font-size:80%">{{ env("NAMASEKOLAH","") }}</p></a>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('siswa.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
    ...
    <strong>Copyright &copy; 2020 <a href="https://smpt.dms.sch.id">Informatika ITATS KKN 2020</a>.</strong>
    All rights reserved.
    </footer>
